...
COMPETITION TITLE: LLM Detect Generated Text

COMPETITION HOST/SPONSOR: The Learning Agency Lab

COMPETITION SPONSOR ADDRESS: 2307 S Rural Rd, Tempe, AZ 85282, USA

COMPETITION WEBSITE: https://www.kaggle.com/competitions/llm-detect-ai-generated-text

TOTAL PRIZES AVAILABLE: $ 110,000
...
*The Efficiency Prizes will be awarded based upon the parameters defined here. Winning a Leaderboard Prize does not preclude you from winning an Efficiency Prize.

WINNER LICENSE TYPE: OPEN SOURCE - MIT

DATA ACCESS AND USE: CC-BY-NC-SA 4.0
...
Open Source: You hereby license and will license your winning Submission and the source code used to generate the Submission under an Open Source MIT license (see https://opensource.org/licenses/MIT) that in no event limits commercial use of such code or model containing or depending on such code. To the extent your Submission makes use of generally commercially available software not owned by you that you used to generate your submission, but that can be procured by the Competition Sponsor without undue expense, you do not grant the license in the preceding sentence to that software.
