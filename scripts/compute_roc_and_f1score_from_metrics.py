...
METRIC_CODENAMES_TO_TEST = {
    "gemma2_2B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "gemma2_9B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "llama3_8B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "falcon_7B":  ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    
    # "smollm_135M": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "smollm_360M": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "smollm_1_7B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "smollm2_135M": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "smollm2_360M": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "smollm2_1_7B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],

    # "gemma2_2B": ["fast_detectgpt"],
    # "llama3_8B": ["fast_detectgpt"],
    # "falcon_7B":  ["fast_detectgpt"],
    # "smollm_135M": ["fast_detectgpt"],
    # "smollm_360M": ["fast_detectgpt"],
    # "smollm_1_7B": ["fast_detectgpt"],
    # "smollm2_135M": ["fast_detectgpt"],
    # "smollm2_360M": ["fast_detectgpt"],
    # "smollm2_1_7B": ["fast_detectgpt"],


    # "gpt_neo_2_7B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"],
    # "gpt_j_6B": ["telescope_perplexity", "binoculars_score", "perplexity", "lrr", "fast_detectgpt"]
    
    # "gpt_neo_2_7B": ["fast_detectgpt"],
    # "gpt_j_6B": ["fast_detectgpt"]
}
...
def _calculate_interpolated_tpr(y_true, y_scores, target_fpr):
    """
    Helper function to calculate TPR at a fixed FPR using ROC interpolation.
    Used by both the point estimate and the bootstrap to ensure consistency.
    """
...
def tpr_at_fixed_fpr(y_true, y_scores, target_fpr=0.05):
    """
    Calculates TPR (Sensitivity) at a specific fixed FPR using linear interpolation
    of the ROC curve.
    """
...
def tpr_at_fixed_fpr(y_true, y_scores, target_fpr=0.05):
    """
    Calculates TPR (Sensitivity) at a specific fixed FPR.
            ...
            for metric_codename in metric_codenames_from_experiment:
                ...
                if SHOULD_PERFORM_TRANSFERABILITY_TEST:
                    ...
                    for train_dataset_index, train_dataset_codename in enumerate(DATASET_CODENAMES_TO_TEST):
                        ...
                        # some datasets are much larger than others, so make sure to only take a few samples from each dataset, 
                        # so that the number of samples from each dataset is roughly equivalent
