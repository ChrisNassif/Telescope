...
# TODO IS THIS EQUIVALENT TO CONVERT_GHOSTBUSTERS_DATASET_TO_TELESCOPE_FORMAT????
# IF IT IS THEN WE SHOULD DELETE CONVERT_GHOSTBUSTERS_DATASET_TO_TELESCOPE_FORMAT.py and then just point people to this script.
# I THINK EVEN THE ATTACK VECTORS DATASET STUFF IS INCLUDED IN HERE???? IF SO THAT WOULD BE GREAT.
